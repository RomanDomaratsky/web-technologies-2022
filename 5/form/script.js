function fieldsCheck(){
    ...
    //Check phone
    let phone = document.getElementById("group");
    if (phone.value === null || !phone.value.match("[A-Z]{2}[a-z]{0,1}\\-[\\d]{2}[a-z]{0,2}")) {
    ...
    //Check faculty
    let faculty = document.getElementById("telegram");
    if (faculty.value === null || !faculty.value.match("\@.+")) {
